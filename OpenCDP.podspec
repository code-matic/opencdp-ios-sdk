#
#  Be sure to run `pod spec lint OpenCDP.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "OpenCDP"
  spec.version      = "1.0.2"
  spec.summary      = "OpenCDP iOS SDK — analytics, push v2, in-app messaging, and optional Customer.io dual-write."
  ...
  spec.author             = { "CodeMatic" => "developers@codematic.io" }
  # Or just: spec.author    = "shodekebarry"
  # spec.authors            = { "shodekebarry" => "barry@prodevs.io" }
  # spec.social_media_url   = "https://twitter.com/shodekebarry"
  ...
  spec.source       = { :git => "https://github.com/code-matic/opencdp-ios-sdk.git", :tag => "#{spec.version}" }
